//
//  YLActivityCircleIndicatorView.m
//  YLRefresh
//
...
@interface YLActivityCircleIndicatorView ()
...
@implementation YLActivityCircleIndicatorView

- (void)setup {
    self.refreshViewLayerType = XHRefreshViewLayerTypeOnScrollViews;
    ...
    self.tintColor = [UIColor colorWithRed:0.259 green:0.780 blue:0.365 alpha:1.000];
