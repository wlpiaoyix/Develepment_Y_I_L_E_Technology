...
+ (NSString *)encodeBase64String:(NSString *)input {
    ...
    __autoreleasing NSString *base64String = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
	return base64String;
}
...
+(NSString *)decryptAESData:(NSData *)data {
    ...
    __autoreleasing  NSString *string = [[NSString alloc] initWithData:decryData encoding:NSUTF8StringEncoding];
    return string;
}
