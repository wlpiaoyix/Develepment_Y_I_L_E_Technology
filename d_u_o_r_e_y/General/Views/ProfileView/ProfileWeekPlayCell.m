...
@interface ProfileWeekPlayCell()

@property (weak, nonatomic) IBOutlet CellWeekPlayView *firstView;
@property (weak, nonatomic) IBOutlet CellWeekPlayView *secondView;
@property (weak, nonatomic) IBOutlet CellWeekPlayView *thirdView;
@property (weak, nonatomic) IBOutlet CellWeekPlayView *fourView;
@property (weak, nonatomic) IBOutlet UIView *moreView;

@end

@implementation ProfileWeekPlayCell
...
- (void)setCellType:(ProfileWeekPlayCellType)cellType{
    _cellType = cellType;
    switch (cellType) {
        case ProfileWeekPlayCellTypeRecent:
