...
- (void)commonInit
{
    ...
    self.mainLabel.baselineAdjustment = UIBaselineAdjustmentAlignBaselines;
...
//                                       constrainedToSize:CGSizeMake(CGFLOAT_MAX, CGRectGetHeight(self.bounds))];
    CGSize labelSize = [self.mainLabel.text boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGRectGetHeight(self.bounds))
