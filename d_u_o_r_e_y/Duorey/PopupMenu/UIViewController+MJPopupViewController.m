...
#define kPTPopupViewShowPostion @"kPTPopupViewShowPostionKey"
...
- (void)setPtPopupViewShowPostion:(PTPopMenuPosition)ptPopupViewShowPostion{
    objc_setAssociatedObject(self, kPTPopupViewShowPostion, [NSNumber numberWithInt:ptPopupViewShowPostion], OBJC_ASSOCIATION_ASSIGN);
}

- (PTPopMenuPosition)ptPopupViewShowPostion{
    return [objc_getAssociatedObject(self, kPTPopupViewShowPostion) intValue];
}

- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType showPostion:(PTPopMenuPosition)position dismissed:(void(^)(void))dismissed
{
    self.mj_popupViewController = popupViewController;
    self.ptPopupViewShowPostion = position;
    [self presentPopupView:popupViewController.view animationType:animationType dismissed:dismissed];
}

- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType showPostion:(PTPopMenuPosition)position
{
    [self presentPopupViewController:popupViewController animationType:animationType showPostion:position dismissed:nil];
}
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(MJPopupViewAnimation)animationType
{
    ...
    switch (animationType) {
        ...
        case MJPopupViewAnimationSlideLeftRight:
        {
            switch (self.ptPopupViewShowPostion) {
                case PTPopMenuPositionTop:
